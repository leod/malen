...
use super::{Context, ElementBuffer, Vertex, VertexArray, VertexBuffer, VertexDecls};
...
pub struct InstancedDrawUnit<'a, V, E = u32>
where
    V: VertexDecls,
{
    vertex_array: &'a VertexArray<V, E>,
...
impl<'a, V, E> InstancedDrawUnit<'a, V, E>
where
    V: VertexDecls,
{
    pub fn new(
